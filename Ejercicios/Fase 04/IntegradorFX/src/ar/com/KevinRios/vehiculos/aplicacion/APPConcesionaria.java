...
package ar.com.KevinRios.vehiculos.aplicacion;

import ar.com.KevinRios.vehiculos.presentacion.controladores.ConcesionariaControlador;
import ar.com.KevinRios.vehiculos.presentacion.controladores.VentanaMaestraControlador;
...
public class APPConcesionaria extends Application {
    ...
    public void initVentanaMaestra() {
        try {
            ...
            VentanaMaestraControlador ventana = loader.getController();
            ventana.setMainApp(this);
